...
const std::string TEST_FSC_PSC_SPMV_HEADER = "rowBlockSize,colGap,numColSegments,numColNNZ,numBlockedPSC,Speedup_FSC,Speedup_PSC_1,Speedup_PSC_2, Speedup_PSC_3";
/**
 * struct { rowBlockSize, colGap, numColSegments, numColNNZ, numBlockedPSC }
 * @param rowBlockSize
 * @param colGap
